...
pollutionAVG %>%
  ...
  geom_boxplot(outline=FALSE) + labs(y = "N2O (million tons per mile)")
```
...
```{r}
ggplot(pollutionAVG, aes(y = CO2_AVG, x = Fuel)) + geom_histogram(stat='identity') + labs(y = "CO2 (million tons per mile)")
```
